...
if flavor == 'muon':
    ...
    if etabin not in ['all', '0p8', '0p8_1p4', '1p4_1p5', '1p5_2p0', '2p0_2p5', 'm0p8', 'm0p8_m1p4', 'm1pm4_m1p5',
                      'm1p5_m2p0', 'm2p0_m2p5']:
        print "wrong etabin"
        sys.exit()
...
fsfout = TFile("/groups/hephy/cms/StopsCompressed/results/%s/finalplots/hephy_scale_factors_%s.root"%(datatag,flavor),"update")
